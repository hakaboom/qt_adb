...
class MainUI(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.devices_list_widget = QWidget(objectName='devices_list_widget')
        self.devices_list_layout = QVBoxLayout(self.devices_list_widget, objectName='devices_list_layout')
        ...
        # ----------------------设备信息栏----------------------
        self.device_info_widget = deviceGrid()  # type: deviceGrid
